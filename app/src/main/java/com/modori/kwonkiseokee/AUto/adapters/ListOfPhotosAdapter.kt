...
import com.modori.kwonkiseokee.AUto.PhotoDetailActivity
import com.modori.kwonkiseokee.AUto.PhotoOnlyActivity
...
//        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.photoCardOfList.setOnLongClickListener {
            val intent = Intent(it.context, PhotoOnlyActivity::class.java)
