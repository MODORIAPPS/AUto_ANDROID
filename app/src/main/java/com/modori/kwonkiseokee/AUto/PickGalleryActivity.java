...
public class PickGalleryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    PickGalleryAdapter photoNewAdapter, photoOldAdapter;
    ...
    public void initWork() {
        ...
        photoOldAdapter = new PickGalleryAdapter(this, photoList, 0);
...
//        adView.loadAd(adRequest);
    ...
    public void setRecyclerView() {
        photoNewAdapter = new PickGalleryAdapter(this, pickedLists, 1);
