...
public class OpenDialog extends Dialog {
    ...
    public OpenDialog(@NonNull final Context context, final int position, String title, String subtitle, List<Tag> tagLists, TagListViewModel viewModel) {
        super(context);
        ...
        this.tagListViewModel = viewModel;
                        ...
                        if (availCnt == 0) {
                            ...
                            if (!TagTool.INSTANCE.overLapTagCheck(tagList, inputTag)) {
                                ...
                                switch (position) {
                                    ...
                                    case 0:
                                        tagListViewModel.update(inputTag,0);

                                        break;
                                    case 1:
                                        tagListViewModel.update(inputTag,1);

                                        break;
                                    case 2:
                                        tagListViewModel.update(inputTag,2);

                                        break;
                                    case 3:
                                        tagListViewModel.update(inputTag,3);

                                        break;
                                    case 4:
                                        tagListViewModel.update(inputTag,4);
                                        break;
                                    case 5:
                                        tagListViewModel.update(inputTag,5);
